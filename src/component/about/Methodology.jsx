...
export default function Methodology({ ref3 }) {
    return (
        <>
            <section ref={ref3} className={styles.methodology_block_content} id="method">
                ...
                <div className={styles.methodology_wrapper}>
                    ...
                    <div className={styles.block_content_desc}>
                        ...
                        <p>Below are all the criteria we use to test, research, analyze, and track the performance of every VPN we review. As a leading authority on VPNs, we aim to build and maintain trust between consumers and the industry. Our expert team has published thousands of real user reviews that are backed by diligent testing and research.</p>

                        <div className={styles.methodology_cards}>
                            <div className={styles.methodology_card}>

                                <div className={styles.methodology_card_img}><img src={secured} alt="VPN" /></div>

                                <div className={styles.methodology_card_info}>
                                    <span className={styles.methodology_card_num}>316</span>
                                    <p> VPNs Reviewed  </p>                      </div>

                            </div>

                            <div className={styles.methodology_card}>

                                <div className={styles.methodology_card_img}><img src={review} alt="User Review" /></div>

                                <div className={styles.methodology_card_info}>
                                    <span className={styles.methodology_card_num}>17,591</span>
                                    <p> Real User Reviews, Ratings     </p>                  </div>
