                    ...
                    <article className={styles.main_article}>
                      ...
                      >
                        <div>
                          ...
                          <ol>
                          <li>A description of the copyrighted work that you claim is being infringed;
</li>
                          <li>
                            {" "}
                          ...
                          <p>The designated copyright agent we have to receive infringement claims can be contacted:</p>
                        </div>
                      </section>
                      <section
                        className={styles.legal_content}
                      ...
                      >
                        ...
                        <div>
                          <p>
                          If you are of the belief that content posted by You to the Site or Services was removed or access to the content was disabled by mistake or misidentification, You may file a DMCA counter-notification with WS by submitting a follow-up written notification to the WS copyright agent. 
                          <br></br>Pursuant to the DMCA, the Counter-Notification must include substantially the following:
                          </p>
                          <ol>
                        ...
                        <p>A counter-notification will allow WS to restore the content that was taken down if the party filing the original DMCA Notice does not file a lawsuit or other legal action against You within ten (10) business days of receiving the Counter-Notification.<br></br>Please be aware that if You knowingly materially misrepresent that material or activity on the Website was removed or disabled by mistake or misidentification, you may be held liable for damages (including costs and attorney fees) under the DMCA (including Section 512(f) of the DMCA.</p>
                        </div>
                      </section>
                      <section
                        className={styles.legal_content}
                      ...
                      >
                        ...
                        <div>
                          <p>
                          Pursuant to the repeat infringer policy requirements of the Digital Millennium Copyright Act, DiscountVPN makes a good faith effort to identify and terminate ANY and ALL repeat infringers that abuse the Site and/or the Services pursuant to the safe harbor requirements of the DMCA.
                          </p>
                        </div>
                      </section>
