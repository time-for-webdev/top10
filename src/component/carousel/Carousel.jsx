...
export default function Carousel() {
  ...
  useEffect(()=>{data_list.map((el,ind)=>{if(el.val){setcardcnt(ind)}});console.log(cardcnt)},[data_list])
  ...
  return (
    <>
      <section className={styles.carousel_sec}>
        ...
        >
           <div className={styles.carousel_card}>
            ...
            <div className={styles.brand_review}>
              ...
              <img src={parseFloat(data_list[cardcnt]?.val.user_rating) > 4.5?fivestar:fourhalfstar} alt="5 star review" />
              <p className={styles.user_review}>
              {data_list[cardcnt]?.val?.user_comment}
              </p>
              <p className={styles.user_name}>{data_list[cardcnt]?.val.user_name}</p>
              <a className={styles.button}>Visit website</a>
            </div>
          </div>


              { data_list.map((el,ind)=>{   return  el?.val ?<div
          ...
          > 
            ...
            <div className={styles.brand_review}>
              <h3>{el.val?.title}</h3>
              <img src={parseFloat(el.val?.user_rating) > 4.5?fivestar:fourhalfstar} alt="5 star review" />
              <p className={styles.user_review}>
              {el.val?.user_comment}
              </p>
              <p className={styles.user_name}>{el.val?.user_name}</p>
              <a className={styles.button} href={el.val?.website_url}>Visit Website</a>
            </div>
          </div> :null
            })
          ...
          <div className={styles.carousel_card}>
            ...
            <div className={styles.brand_review}>
              ...
              <img src={parseFloat(data_list[0]?.val.user_rating) > 4.5?fivestar:fourhalfstar} alt="5 star review" />
              <p className={styles.user_review}>
        ...
        {data_list.map((el,ind)=>{ return el?.val?<span
