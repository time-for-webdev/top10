        ...
        <div className={styles.container}>
          <div class="category__content-wrapper">
            <h3 className={styles.section_title} data-qa-id="category_title">
              The Best VPNs Per Category{" "}
            </h3>
            <div
              className={styles.category__list}
              data-qa-id="vendor_category_list"
            >
                    ...
                    >
                      ...
                      <div className={styles.category__item_logo_wrapper}>
                        <a
                          ...
                          href={el?.val?.website_url}
                          onclick="clickedLinkExternal('Windows - best_vpns_by_category', 'ExpressVPN')"
                          rel="nofollow noopener noreferrer"
                          target="_blank"
                          data-tracked="yes"
                        ></a>
                        <img
                          data-qa-id="category_item_logo_1"
                      ...
                      <div className={styles.category__item_features}>
                        <a
                          ...
                          className={styles.overlay_link}
                          href={el?.val?.website_url}
                          onclick="clickedLinkExternal('Windows - best_vpns_by_category_badges', 'ExpressVPN')"
                          rel="nofollow noopener noreferrer"
                          target="_blank"
                          data-tracked="yes"
                        ></a>
                        <div
                          className={styles.category__item_features}
                          data-qa-id="category_item_features_1"
                        >
                          {el?.val?.feature.map((ob, index) => {
                            return (
                              <div className={styles.category__item_feature}>
                                <span
                                  className={
                                    styles.category__item_feature_label
                                  }
                                >
                                  <img
                                    style={{
                                    ...
                                    src={
                                      ob?.category.toLowerCase() == "privacy"
                                        ? Privacy
                                        : ob?.category.toLowerCase() ==
                                          "newbies"
                                        ? Newbies
                                        : ob?.category.toLowerCase() == "speed"
                                        ? Speed
                                        : ob?.category.toLowerCase() ==
                                          "security"
                                        ? Security
                                ...
                                <i
                                  className={
                                    styles.category__item_feature_check
                                  }
                                >
                                  <img
                                    src={checkMark}
